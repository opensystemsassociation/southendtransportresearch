    ...
    */
    var pictureTakenHandler = function() {
        window.takePicture(function(message) {
            ...
            setTimeout(pictureTakenHandler, 2000)
        });
    };
    pictureTakenHandler(); 
};
...
var getLocation = function() {
    ...
    var locFail = function() {
        document.getElementById("location").innerHTML = 'Failed!';
    };
...
function updateAcceleration(a) {
    var accelString = roundNumber(a.x)+':'+roundNumber(a.y)+':'+roundNumber(a.z);
    document.getElementById('accel').innerHTML = accelString;
}
...
window.takePicture = function(callback) {
    cordova.exec(callback, function(err) {
        callback(err);
        // callback('Nothing to echo.');
    }, "CameraAccessNoUserAction", "takePicture", []);
};
